    ...
    OutlinedTextField(
        ...
        placeholder = {
            Text(
                ...
                style = textStyle,
                color = MaterialTheme.colorScheme.onSurface.copy(com.sneha.khanu.composetodolist.foundation.theme.AlphaDisabled)
            )
        },
        modifier = modifier
            .height(56.dp)
                ...
                PgIconButton(
                    ...
                    PgIcon(
                        ...
                        tint = if (isValid) {
                            ...
                            LocalContentColor.current.copy(alpha = com.sneha.khanu.composetodolist.foundation.theme.AlphaDisabled)
                        }
                    )
                }
            }
